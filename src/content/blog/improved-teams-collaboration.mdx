...
new improvements to the teams feature in Digizus that increases collaboration and streamlines access to websites.
...
The Digizus navbar now has a dropdown menu that lets you quickly switch between your personal account and your teams.
...
In Digizus Cloud, there is now a transfer website feature that lets you transfer a website between your
...
The new teams feature is available to all users now in [Digizus Cloud](https://cloud.digizus.is?ref=digizus-blog). It will be available to self-host users in the next release
of Digizus v1.0.0.
